...
# /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:1:CFBundleURLName string 'SSH Connection'" "$INFO_PLIST"
# /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:1:CFBundleURLSchemes array" "$INFO_PLIST"
# /usr/libexec/PlistBuddy -c "Add :CFBundleURLTypes:1:CFBundleURLSchemes:0 string ssh" "$INFO_PLIST"
