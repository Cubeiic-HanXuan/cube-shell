...
from PySide6.QtCore import (
    QIODevice, QObject, Signal, QSocketNotifier, QCoreApplication, Slot
)

# 导入KPty模块
from qtermwidget.kpty import KPty, KPtyPrivate
...
# 平台特定的ioctl命令定义
if sys.platform in ['freebsd', 'darwin']:  # FreeBSD, macOS
